...
double computeTax(float income)
{
	...
	if (income >= 15100)
	  {
		 yearlyTax += 0.15 * (yearlyIncome - 15100);
	  }
	if (income >= 61300)
	  {
		 yearlyTax = 0.25 * (yearlyIncome - 61300);
	  }
	if (income >= 123700)
	  {
		 yearlyTax = 0.28 * (yearlyIncome - 123700);
	  }
	if (income >= 188450)
	  {
		 yearlyTax = 0.33 * (yearlyIncome - 188450);
	  }
	if (income >= 336550)
	  {
		 yearlyTax = 0.28 * (yearlyIncome - 336550);
	  }
